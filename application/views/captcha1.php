...
if ($flag == 1) {
    if ($input == $_SESSION['captcha_string']) {
        ...
        <div style="text-align:center;">
            ...
            <form action=" <?php echo base_url()?>ajaxc/ajax_v" method="POST">
                <input type="submit">
            </form>
...
function display()
{
    ...
    <div style="text-align:center;">
        ...
        <div style="display:block;margin-bottom:20px;margin-top:20px;">
            <img src="<?php echo base_url()?>image<?php echo $_SESSION['count'] ?>.png">
        </div>
        <form action="<?php echo base_url() ?>ajaxc/captcha1" method="POST">
