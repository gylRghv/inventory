    ...
    function Plugin(element, options) {
            ...
            var html = '<div class="js-gallery" id="' + galleryId + '" style="z-index: ' + options.zIndex + '">' +
                            '<div class="jsg-topbar">' +
                                '<div class="jsg-title">' +
                                    ...
                                    '<div class="jsg-btns"> <i class="fa fa-close jsg-close"></i></div>' +
                                    albumList +
                            ...
                            '<div class="jsg-content">' +
                                ...
                                '<div class="jsg-nav">' +
                                    '<div class="jsg-prev"><i class="fa fa-angle-left"></i></div>' +
                                    '<div class="jsg-next"><i class="fa fa-angle-right"></i></div>' +
                                '</div>' +
                                '<div class="clearfix"></div>' +
                            '</div>' +
                       '</div>';
        ...
        function selectImage(imageIndex){
            ...
            if(loadedImages.indexOf(currentImage) < 0){
                $gallery.find('.jsg-images').append('<div class="preloader"><i></i></div>');
